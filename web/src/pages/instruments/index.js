...
const INSTRUMENTS = [
  ...
  },
  {
    slug: "mercury",
    name: "Mercury",
    tagline: "3:2 spin–orbit resonance, perihelion advance, MESSENGER impact site.",
    status: "live",
  },
  {
    slug: "venus",
    name: "Venus",
    tagline: "Greenhouse to 737 K, retrograde 243-d day, every Venera + Vega landing.",
    status: "live",
  },
  {
    slug: "earth",
    name: "Earth",
    tagline: "Scale height, lunar Hill sphere, observatories and launch sites.",
    status: "live",
  },
  {
    slug: "mars",
    name: "Mars",
    tagline: "Olympus Mons, Valles Marineris, every successful surface mission.",
    status: "live",
  },
  {
    slug: "jupiter",
    name: "Jupiter",
    tagline: "Great Red Spot, Roche limit, Galileo entry probe.",
    status: "live",
  },
  {
    slug: "saturn",
    name: "Saturn",
    tagline: "Hexagonal polar vortex, ring outer edge at the Roche limit.",
    status: "live",
  },
  {
    slug: "uranus",
    name: "Uranus",
    tagline: "97.77° axial tilt, magnetic dipole offset, Voyager 2 flyby.",
    status: "live",
  },
  {
    slug: "neptune",
    name: "Neptune",
    tagline: "580 m/s supersonic winds, Triton retrograde decay, Voyager 2 flyby.",
    status: "live",
  },
  {
    slug: "sky-survey",
